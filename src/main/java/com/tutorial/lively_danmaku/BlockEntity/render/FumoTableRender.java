...
public class FumoTableRender implements BlockEntityRenderer<FumoTableEntityBlock> {
    public FumoTableRender(BlockEntityRendererProvider.Context renderer) {
    }
    @Override
    public void render(@NotNull FumoTableEntityBlock fumoTable, float partialTicks, PoseStack ms, MultiBufferSource buffer, int light, int overlay) {
