...
public class StarDanmakuRender extends EntityRenderer<StarDanmaku> {
    ResourceLocation TEXTURE_LOCATION = new ResourceLocation("lively_danmaku", "textures/entity/star.png");
    private static final RenderType[] RENDER_TYPE = {
            RenderType.entityCutoutNoCull(new ResourceLocation("lively_danmaku", "textures/entity/star.png")),
            RenderType.entityCutoutNoCull(new ResourceLocation("lively_danmaku","textures/entity/star1.png")),
            RenderType.entityCutoutNoCull(new ResourceLocation("lively_danmaku","textures/entity/star2.png"))
    };
