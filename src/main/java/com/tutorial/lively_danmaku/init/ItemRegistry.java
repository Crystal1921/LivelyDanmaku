...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> Player = ITEMS.register("player", () -> new ForgeSpawnEggItem(EntityTypeRegistry.lively_danmaku_1921,0xFFFFFF, 0xFFFFFF,new Item.Properties()));
