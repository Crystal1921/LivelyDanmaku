...
public class EntityRenderRegistry {
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityTypeRegistry.lively_danmaku_1921.get(), m -> new PlayerRender(m, new PlayerModel<>(m.bakeLayer(ModelLayersRegistry.lively_danmaku),true),0.3F));
    }
}