...
public class Crystal1921Model<T extends siborary> extends HumanoidModel<T> {
    ...
    public Crystal1921Model(ModelPart modelPart,boolean slim) {
        super(modelPart);
        this.slim = slim;
        ...
        List<ModelPart> parts = modelPart.getAllParts().filter((p_170824_) -> !p_170824_.isEmpty()).collect(ImmutableList.toImmutableList());
    }
