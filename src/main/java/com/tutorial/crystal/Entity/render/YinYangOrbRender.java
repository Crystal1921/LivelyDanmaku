...
import com.tutorial.crystal.Entity.YinYangOrb;
...
public class YinYangOrbRender extends EntityRenderer<YinYangOrb> {
    public static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("crystal", "textures/entity/yin_yang_orb.png");
