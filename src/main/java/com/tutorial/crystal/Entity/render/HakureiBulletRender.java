...
public class HakureiBulletRender extends EntityRenderer<Hakurei_bullet> {
    ...
    public static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("crystal", "textures/entity/hakurei_bullet1.png");
    private static final RenderType[] RENDER_TYPE = {
            RenderType.entityCutoutNoCull(new ResourceLocation("crystal", "textures/entity/hakurei_bullet1.png")),
            RenderType.entityCutoutNoCull(new ResourceLocation("crystal","textures/entity/hakurei_bullet2.png")),
            RenderType.entityCutoutNoCull(new ResourceLocation("crystal","textures/entity/hakurei_bullet3.png"))
    };
