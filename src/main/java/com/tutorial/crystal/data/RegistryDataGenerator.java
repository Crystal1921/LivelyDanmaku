package com.tutorial.crystal.data;

import com.tutorial.crystal.Util.EntityExcludedDamageSource;
...
public class RegistryDataGenerator extends DatapackBuiltinEntriesProvider {
    ...
    public RegistryDataGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
        super(output, provider, BUILDER, Set.of("minecraft", Utils.MOD_ID));
    }
    public static void addProviders(boolean isServer, DataGenerator generator, PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
